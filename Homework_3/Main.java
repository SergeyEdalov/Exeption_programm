...
public class Main {
    public static void main(String[] args) {
         ...
         * не совпадает с требуемым,
         * вернуть код ошибки. Создать метод, который обработает его и покажет
         ...
         * типу проблемы.
         * Можно использовать встроенные типы java или создать свои. Исключение должно
        ...
        CheckerHuman checkDataUser = new CheckerHuman(date, dataUser.getData());
        checkDataUser.checkByNumber(dataUser.getData());
        Map<String, String> mapDataUser = new HashMap<>(dataUser.sortData(dataUser.getData()));
        checkDataUser.checkByFormat(mapDataUser);

        dataUser.inputDataToFile(null, mapDataUser);
    }
}
